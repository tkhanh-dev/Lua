...
spawn(function()
	while task.wait() do
		if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
            MirageCheck:Refresh("Mirage Island : Spawn Ã¢Å“â€¦")
        else
            MirageCheck:Refresh("Mirage Island : Not Spawn Ã¢ÂÅ’")
        end
	end
end)
...
spawn(function()
	while task.wait() do
		if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
            KitsuneCheck:Refresh("Kitsune Island : Spawn Ã¢Å“â€¦")
        else
            KitsuneCheck:Refresh("Kitsune Island : Not Spawn Ã¢ÂÅ’")
        end
	end
end)
...
spawn(function()
    while wait() do
        if game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
            MoonCheck:Refresh("Moon Status : Ã°Å¸Å’â€˜ 100%")
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
            MoonCheck:Refresh("Moon Status : Ã°Å¸Å’â€™ 75%")
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
            MoonCheck:Refresh("Moon Status : Ã°Å¸Å’â€œ 50%")
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
            MoonCheck:Refresh("Moon Status : Ã°Å¸Å’â€” 25%")
        elseif game:GetService("Lighting").Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
            MoonCheck:Refresh("Moon Status : Ã°Å¸Å’â€“ 15%")
        else
            MoonCheck:Refresh("Moon Status : Ã°Å¸Å’Å¡ 0%")
        end
    end
end)
...
spawn(function()
    while task.wait() do
        if GetWeaponInventory("Tushita") == true then
            TushitaSword:Refresh("Tushita Sword : Have Ã¢Å“â€¦")
        elseif GetWeaponInventory("Tushita") == false then
            TushitaSword:Refresh("Tushita Sword : Not Have Ã¢ÂÅ’")
        end

        if GetWeaponInventory("Yama") == true then
            YamaSword:Refresh("Yama Sword : Have Ã¢Å“â€¦")
        elseif GetWeaponInventory("Yama") == false then
            YamaSword:Refresh("Yama Sword : Not Have Ã¢ÂÅ’")
        end
    end
end)
...
RaceFragShop:addButton("Suprise Bone [ Ã°Å¸Â¦Â´50 Bone ]", function()
    local args = {
        [1] = "Bones",
        [2] = "Buy",
        [3] = 1,
...
RaceFragShop:addButton("Stat Refund [ Ã°Å¸Â¦Â´50 Bone ]", function()
    local args = {
        [1] = "Bones",
        [2] = "Buy",
        [3] = 1,
...
RaceFragShop:addButton("Race Reroll [ Ã°Å¸Â¦Â´50 Bone ]", function()
    local args = {
        [1] = "Bones",
        [2] = "Buy",
        [3] = 1,
